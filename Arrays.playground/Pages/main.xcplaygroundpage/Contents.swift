...
var list = ["Bread", "Butter", "Cheese", "Lettuce", "Tomatos"]
...
var shoppingList: [String] = ["Bread", "Butter", "Cheese", "Lettuce", "Tomatos"]
...
func lifeEssential(ingridients: [String]) -> Bool {
    
    if ingridients[0] == "Bread" {
        return true
    } else {
        return false
    }
...
print(lifeEssential(desertList))
